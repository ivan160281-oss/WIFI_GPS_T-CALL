...
// ---------------------------------------------------------------------------
// Board pin definitions - LILYGO T-Call A7670 V1.0/V1.1
// ---------------------------------------------------------------------------
...
// TinyGSM's internal line buffer needs to be generous enough for AT+CGNSSINFO
// responses and the HTTP response body we read back - do this before the
// TinyGsmClient.h include, not after (it's a compile-time buffer size).
